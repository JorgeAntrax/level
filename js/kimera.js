...
if (modal.length > 0) {
    for (let i = 0; i < modal.length; i++) {
        ...
        /*
				function that controls the visibility of the modal windows
        */
...
if (navbar.length > 0) {
    ...
    /* 
		function that controls the visibility of the navigation bar menu
    */
    function navToggle() {
...
for (let i = 0; i < tab.length; i++) {
    ...
    /*
		function that controls the navigation by tabs
     */
